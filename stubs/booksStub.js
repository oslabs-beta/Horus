...
const ClientWrapper = new HorusClientWrapper(client, BooksService, "books.txt", 'mongodb+srv://testUsername:testPassword@cluster0-rfgdc.mongodb.net/requests?retryWrites=true&w=majority');
